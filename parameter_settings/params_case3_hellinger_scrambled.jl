# parameters for Hellinger ER-DRO + OLS with Algorithm 2 for selecting the radius and d_x = 100
...
# set Hellinger radii
const hellingerRadius = [0;linspace(0.001,0.009,9);linspace(0.01,0.09,9);linspace(0.1,0.9,9)]
