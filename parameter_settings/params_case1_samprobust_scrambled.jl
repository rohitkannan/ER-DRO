# parameters for Sample Robust ER-DRO + OLS with Algorithm 2 for selecting the radius and d_x = 3
...
const numDataSamples = Int64[20,40,80,200]
...
# set ambiguity set radii
const sampRobustRadius = [0;linspace(0.001,0.009,9);linspace(0.01,0.09,9);linspace(0.1,0.9,9)]
