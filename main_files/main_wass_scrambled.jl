# main file for solving the Wasserstein ER-DRO problem using Algorithm 2 for specifying the radius
...
#*========= MODEL INFORMATION ==========
const caseNum = 1
const paramsFile = "params_case" * string(caseNum) * "_wass_scrambled.jl"
#*======================================
...
include("getScrambledWassersteinRadius.jl")
#*======================================
...
const baseDirName = "case" * string(caseNum) * "_wass_scrambled/" * "mod_" * string(modRepNum) * "/" * "deg_" * string(degNum) * "/"
...
optWassersteinRadius, radiusQuality = getWassersteinRadius(returns_data,covariate_data,wassersteinRadius,regressionMethod,coeff_true)
