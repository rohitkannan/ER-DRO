# main file for solving the Wasserstein ER-DRO problem using Algorithm 1 for specifying the radius
...
#*========= MODEL INFORMATION ==========
const caseNum = 1
const paramsFile = "params_case" * string(caseNum) * "_wass_naive.jl"
#*======================================
...
include("getNaiveWassersteinRadius.jl")
#*======================================
...
const baseDirName = "case" * string(caseNum) * "_wass_naive/" * "mod_" * string(modRepNum) * "/" * "deg_" * string(degNum) * "/"
...
optWassersteinRadius, radiusQuality = getWassersteinRadius(returns_data,wassersteinRadius)
